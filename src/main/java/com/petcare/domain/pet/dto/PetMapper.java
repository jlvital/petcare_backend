...
/**
 * Clase utilitaria para convertir entre entidades {@link Pet} y sus DTOs asociados.
 * <p>
...
public class PetMapper {
     ...
     * <p>
     * Incluye lógica para mostrar correctamente el género personalizado si se eligió "OTRO".
     *
     * @param pet Entidad de mascota que se desea mapear.
     * @return Objeto {@link PetResponse} con los datos visibles al cliente, o {@code null} si la entrada es nula.
     */
	...
	public static PetResponse toResponse(Pet pet) {
	    ...
	    if (pet.getPetGender() == PetGender.OTRO && pet.getCustomGender() != null && !pet.getCustomGender().isBlank()) {
	        genderLabel = pet.getCustomGender().trim();
	    } else if (pet.getPetGender() != null) {
	    ...
	    return PetResponse.builder()
	            ...
	            .customGender(pet.getCustomGender())
	            .type(pet.getType())
	            .customType(pet.getCustomType())
	            ...
	            .sterilizationDate(pet.getSterilizationDate())
	            .observations(pet.getObservations())
	            .build();
	}

    /**
     * Convierte un objeto {@link PetRequest} (formulario de entrada) en una entidad {@link Pet}.
     * <p>
     * Se utiliza durante el proceso de registro, asociando también al cliente propietario.
     *
     * @param request Datos del formulario de registro de mascota.
     * @param client Cliente autenticado que registra la mascota.
     * @return Entidad {@link Pet} lista para persistir, o {@code null} si algún dato clave es nulo.
     */
    public static Pet toEntity(PetRequest request, Client client) {
        ...
        pet.setCustomGender(request.getCustomGender());
    ...
    /**
     * Aplica los cambios contenidos en un objeto {@link PetUpdate} a una entidad {@link Pet}.
     * <p>
     * Solo se modifican aquellos campos que se han informado (no nulos).
     * Este método se utiliza para actualizaciones desde el área de cliente.
     *
    ...
    public static void updateEntityFromRequest(PetUpdate request, Pet pet) {
        if (request != null && pet != null) {
            ...
            if (request.getCustomGender() != null) {
                pet.setCustomGender(request.getCustomGender());
            }
